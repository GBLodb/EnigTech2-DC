...
BlastFurnace.addRecipe(<appliedenergistics2:material:5>, <ore:dustQuartz>, 200);
...
BlastFurnace.addRecipe(<ore:ingotTungsten>.firstItem, <ore:oreTungsten>, 500);
BlastFurnace.addRecipe(<ore:ingotTungsten>.firstItem, <ore:dustTungsten>, 500);
BlastFurnace.addRecipe(<ore:ingotChromium>.firstItem, <ore:dustChromium>, 500);
