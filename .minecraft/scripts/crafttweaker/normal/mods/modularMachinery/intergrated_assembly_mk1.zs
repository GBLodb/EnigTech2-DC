...
RecipeBuilder.newBuilder(machineName + "_medidum_core", machineName, 64)
...
RecipeBuilder.newBuilder(machineName + "_magic_motor", machineName, 48)
    .addEnergyPerTickInput(64)
...
RecipeBuilder.newBuilder(machineName + "_bad_processor", machineName, 48)
    .addEnergyPerTickInput(64)
...
RecipeBuilder.newBuilder(machineName + "_engineering_processor", machineName, 48)
    .addEnergyPerTickInput(64)
...
RecipeBuilder.newBuilder(machineName + "_logic_processor", machineName, 48)
    .addEnergyPerTickInput(64)
...
RecipeBuilder.newBuilder(machineName + "_calculation_processor", machineName, 48)
    .addEnergyPerTickInput(64)
...
RecipeBuilder.newBuilder(machineName + "_magic_machine_hull", machineName, 96)
    .addEnergyPerTickInput(64)
...
RecipeBuilder.newBuilder(machineName + "_pressure_sink", machineName, 48)
    .addEnergyPerTickInput(64)
    .addItemInput(<ore:plateTungstenSteel>.firstItem*2)
    .addItemOutput(<advancedrocketry:pressuretank:3>)
	.build();

RecipeBuilder.newBuilder(machineName + "_high_pressure_sink", machineName, 64)
    .addEnergyPerTickInput(64)
...
//聚星缸
RecipeBuilder.newBuilder(machineName + "_blockwell", machineName, 128)
...
//高等机械核心
RecipeBuilder.newBuilder(machineName + "_machine_core_advanced", machineName, 128)
...
//超等机械核心
RecipeBuilder.newBuilder(machineName + "_machine_core_ultra", machineName, 128)
...
//星辉工作台
RecipeBuilder.newBuilder(machineName + "_blockaltar", machineName, 128)
 ...
 //压缩空间制造器
 RecipeBuilder.newBuilder(machineName + "_fieldprojector", machineName, 320)
    .addEnergyPerTickInput(375)
    .addFluidInput(<liquid:fluid_lubricant>*50)
 ...
 //连接器
 RecipeBuilder.newBuilder(machineName + "_connector", machineName, 128)
...
//龙芯
RecipeBuilder.newBuilder(machineName + "_draconic_core", machineName, 128)
    .addEnergyPerTickInput(1250)
...
//聚合核心
RecipeBuilder.newBuilder(machineName + "_fusion_crafting_core", machineName, 128)
    .addEnergyPerTickInput(1250)
...
//注入装置
RecipeBuilder.newBuilder(machineName + "_crafting_injector", machineName, 128)
    .addEnergyPerTickInput(1250)
    .addFluidInput(<liquid:fluid_dragon_breathe>*2000)
...
//量子采石场
RecipeBuilder.newBuilder(machineName + "_quarry", machineName, 128)
    .addEnergyPerTickInput(1250)
...
//精英合成组件
RecipeBuilder.newBuilder(machineName + "_cc_elite", machineName, 80)
