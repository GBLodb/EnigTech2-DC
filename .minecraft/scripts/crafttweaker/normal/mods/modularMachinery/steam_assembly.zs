...
RecipeBuilder.newBuilder(machineName + "_medidum_core", machineName, 80)
...
RecipeBuilder.newBuilder(machineName + "_magic_motor", machineName, 60)
	.addFluidInput(<liquid:steam>*1000)
...
RecipeBuilder.newBuilder(machineName + "_bad_processor", machineName, 60)
	.addFluidInput(<liquid:steam>*1000)
...
RecipeBuilder.newBuilder(machineName + "_engineering_processor", machineName, 60)
	.addFluidInput(<liquid:steam>*1000)
...
RecipeBuilder.newBuilder(machineName + "_logic_processor", machineName, 60)
	.addFluidInput(<liquid:steam>*1000)
...
RecipeBuilder.newBuilder(machineName + "_calculation_processor", machineName, 60)
	.addFluidInput(<liquid:steam>*1000)
...
RecipeBuilder.newBuilder(machineName + "_magic_machine_hull", machineName, 120)
	.addFluidInput(<liquid:steam>*1000)
...
RecipeBuilder.newBuilder(machineName + "_pressure_sink", machineName, 60)
	.addFluidInput(<liquid:steam>*1000)
    .addItemInput(<ore:plateTungstenSteel>.firstItem*2)
    .addItemOutput(<advancedrocketry:pressuretank:3>)
	.build();

RecipeBuilder.newBuilder(machineName + "_high_pressure_sink", machineName, 80)
	.addFluidInput(<liquid:steam>*1000)
