...
//钢制机壳
recipes.addShaped(<mekanism:basicblock:8>,[[<ore:plateTungstenSteel>,<thermalfoundation:glass:3>,<ore:plateTungstenSteel>],[<thermalfoundation:glass:3>,<contenttweaker:ultra_machine_core>,<thermalfoundation:glass:3>],[<ore:plateTungstenSteel>,<thermalfoundation:glass:3>,<ore:plateTungstenSteel>]]);
//透镜
...
//富集仓
recipes.addShaped(<mekanism:machineblock>,[[<actuallyadditions:item_crystal_empowered>,<mekanism:controlcircuit>,<actuallyadditions:item_crystal_empowered>],[<ore:ingotAstralStarmetal>,<mekanism:basicblock:8>,<ore:ingotAstralStarmetal>],[<actuallyadditions:item_crystal_empowered>,<mekanism:controlcircuit>,<actuallyadditions:item_crystal_empowered>]]);
//能量板
...
recipes.addShaped(<nuclearcraft:salt_fission_heater> * 4, [[<thermalfoundation:material:359>, <contenttweaker:material_part:79>, <thermalfoundation:material:359>],[<contenttweaker:material_part:79>, null, <contenttweaker:material_part:79>], [<thermalfoundation:material:359>, <contenttweaker:material_part:79>, <thermalfoundation:material:359>]]);
...
recipes.addShapeless(<contenttweaker:plastic_plate>, [<mekanism:hdpe_sheet>]);
...
recipes.addShaped(<mekanism:machineblock2:14>, [[<ore:plateTungstenSteel>, <ore:plateTungstenSteel>, <ore:plateTungstenSteel>],[<extrautils2:ineffableglass>, <contenttweaker:magic_machine_hull>, <extrautils2:ineffableglass>], [<ore:plateTungstenSteel>, <ore:plateTungstenSteel>, <ore:plateTungstenSteel>]]);
recipes.addShaped(<extrautils2:ingredients:5> * 8, [[<ore:dustAstralStarmetal>, <contenttweaker:lunar_essence>, <ore:dustAstralStarmetal>],[<minecraft:nether_star>, <ore:ingotUnstable>, <minecraft:nether_star>], [<ore:dustAstralStarmetal>, <contenttweaker:lunar_essence>, <ore:dustAstralStarmetal>]]);
...
recipes.addShaped(<mekanismgenerators:generator:11>*4, [[<ore:plateTungstenSteel>, <contenttweaker:material_part:81>, <ore:plateTungstenSteel>],[<ore:plateTungstenSteel>, <contenttweaker:strong_motor>, <ore:plateTungstenSteel>], [<ore:plateTungstenSteel>, <contenttweaker:material_part:81>, <ore:plateTungstenSteel>]]);
recipes.addShaped(<mekanismgenerators:generator:10> * 4, [[<ore:plateTungstenSteel>, <ore:plateTungstenSteel>, <ore:plateTungstenSteel>],[<ore:plateTungstenSteel>, <contenttweaker:material_part:69>, <ore:plateTungstenSteel>], [<ore:plateTungstenSteel>, <ore:plateTungstenSteel>, <ore:plateTungstenSteel>]]);
recipes.addShaped(<mekanismgenerators:generator:9> * 2, [[<contenttweaker:material_part:43>, <ore:rodNeodymium>, <contenttweaker:material_part:43>],[<contenttweaker:material_part:43>, <ore:rodNeodymium>, <contenttweaker:material_part:43>], [<contenttweaker:material_part:43>, <ore:rodNeodymium>, <contenttweaker:material_part:43>]]);
recipes.addShaped(<mekanismgenerators:generator:8> * 4, [[<contenttweaker:material_part:43>, <contenttweaker:advanced_motioner>, <contenttweaker:material_part:43>],[<contenttweaker:material_part:43>, <ore:rodNeodymium>, <contenttweaker:material_part:43>], [<contenttweaker:material_part:43>, <contenttweaker:advanced_motioner>, <contenttweaker:material_part:43>]]);
...
recipes.addShaped(<environmentaltech:interconnect> * 2, [[<thermalfoundation:material:359>, <thermalfoundation:material:359>, <thermalfoundation:material:359>],[<ore:plateTungstenSteel>, <environmentaltech:connector>, <ore:plateTungstenSteel>], [<thermalfoundation:material:359>, <thermalfoundation:material:359>, <thermalfoundation:material:359>]]);
...
recipes.addShaped(<environmentaltech:solar_cell_ionite>,[[<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>],[<ore:plateVoidMetal>,<nuclearcraft:part:10>,<ore:plateVoidMetal>],[<mekanism:controlcircuit:3>,<environmentaltech:ionite_crystal>,<mekanism:controlcircuit:3>]]);
recipes.addShaped(<environmentaltech:solar_cell_aethium>,[[<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>],[<environmentaltech:aethium_crystal>,<environmentaltech:solar_cell_ionite>,<environmentaltech:aethium_crystal>],[<ore:plateVoidMetal>,<environmentaltech:aethium_crystal>,<ore:plateVoidMetal>]]);
