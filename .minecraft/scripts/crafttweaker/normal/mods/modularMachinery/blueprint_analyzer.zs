...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_blueprint", machineName, 20*60)
    ...
    .addItemOutput(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:blast_furnace_mk5_terminal"})).setChance(0.16)
    .addItemOutput(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:blast_furnace_mk5_eternal"})).setChance(0.16)
    .addItemOutput(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:intergrated_assembly_mk2"})).setChance(0.06)
	.build();