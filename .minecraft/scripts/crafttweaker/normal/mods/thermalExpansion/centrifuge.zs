...
Centrifuge.addRecipe([<ore:dustAstralStarmetal>%10,<contenttweaker:lunar_essence>%2], <advancedrocketry:moonturf>, <liquid:astralsorcery.liquidstarlight>*150, 8000);
