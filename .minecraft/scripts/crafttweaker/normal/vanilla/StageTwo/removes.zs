...
recipes.remove(<retro_sophisticated_backpacks:backpack_leather>);
recipes.remove(<retro_sophisticated_backpacks:stack_upgrade_starter_tier>);
recipes.remove(<retro_sophisticated_backpacks:stack_upgrade_tier_1>);
recipes.remove(<retro_sophisticated_backpacks:stack_upgrade_tier_2>);
