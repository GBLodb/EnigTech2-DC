...
BlastFurnace.addRecipe(<appliedenergistics2:material:5>, <ore:dustQuartz>, 160);
...
BlastFurnace.addRecipe(<ore:ingotTungsten>.firstItem, <ore:oreTungsten>, 160);
BlastFurnace.addRecipe(<ore:ingotTungsten>.firstItem, <ore:dustTungsten>, 200);
BlastFurnace.addRecipe(<ore:ingotChromium>.firstItem, <ore:dustChromium>, 200);
