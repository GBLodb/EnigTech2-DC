...
Centrifuge.addRecipe([<ore:dustAstralStarmetal>.firstItem%10,<contenttweaker:lunar_essence>%2], <advancedrocketry:moonturf>, <liquid:astralsorcery.liquidstarlight>*100, 8000);
